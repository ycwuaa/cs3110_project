...
val place_original_armies: t -> player_id -> int -> (int * territory) list
 ...
 * added *)
val place_new_armies : t -> player_id -> int -> (int * territory)
...
val choose_attack : t -> player_id -> (territory * territory * int) option
 ...
 * move *)
val choose_move_conquerors : t -> player_id -> territory -> territory -> int -> int
...
val redistribute_armies : t -> player_id -> (territory * territory * int) option
