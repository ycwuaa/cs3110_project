...
(** at the beginning of the game (after the first army on each territory is
 * placed automatically), decide where to put the remaining armies, and return a
 * corresponding (int * territory) list *)
